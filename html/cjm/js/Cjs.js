$(function(){
    $(".li1").mouseover(function () {
        $(".t").stop().animate({"height":'0px'},300)
        $(".m").stop().animate({"height":"0px","top":"600px"},300)
        $(".li1").mouseout(function () {
            $(".t").stop().animate({"height":'300px'},300)
            $(".m").stop().animate({"height":"300px","top":"300px"},300)
        })
    })
    $(".li2").mouseover(function () {
        $(".o").stop().animate({"height":'0px'},300)
        $(".l").stop().animate({"height":"0px","top":"600px"},300)
        $(".li2").mouseout(function () {
            $(".o").stop().animate({"height":'300px'},300)
            $(".l").stop().animate({"height":"300px","top":"300px"},300)
        })
    })

    $('#cy>ul>li').mouseover(function(){
        $(this).css("backgroundColor","#B6BABE")

    })
    $('#cy>ul>li').mouseout(function(){
